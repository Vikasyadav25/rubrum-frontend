...
export default (state = INIT_STATE, action) => {
    switch (action.type) {
      ...
      case UPDATE_INSTRUCTION_POSITIVE_TOLERANCE: {
        return {
          ...state,
          loading: false,
          instructionUpdateSuccess: false,
          instructionUpdateFailure: false,
          isPositiveToleranceError: true,
          ptErrorCode: action?.payload?.code,
          ptWeight: action?.payload?.pt,
          error: false,
        };
      }
      ...
      case actionTypes.FETCH_INWARD_MATERIAL_LIST_ERROR: {
        return {
          ...state,
          loading: false,
          error: true,
      ...
      case actionTypes.FETCH_INWARD_MATERIAL_LIST_SUCCESS: {
        return {
          ...state,
          loading: true,
          error: false,
